...
const richText = cn(
  ...
  "[&_p]:mb-5",
  "[&_a]:text-primary [&_a]:underline [&_a]:underline-offset-4 [&_a:hover]:underline-offset-2 [&_a]:transition-all",
  ...
  "[&_blockquote]:my-5 [&_blockquote]:border-l-4 [&_blockquote]:border-muted-foreground/30 [&_blockquote]:pl-5 [&_blockquote]:italic [&_blockquote]:text-muted-foreground",
...
function Block({ block }: { block: ArticleBlock }) {
  switch (block.type) {
    case "text":
      return <div className={richText} dangerouslySetInnerHTML={{ __html: block.text }} />;
      ...
      return (
        <figure className="space-y-2">
          <div className="overflow-hidden rounded-lg">
            ...
            <pre className="overflow-x-auto bg-zinc-900 p-4 text-sm font-mono leading-relaxed text-zinc-100">
      ...
      return (
        <aside
          className={cn(
            ...
            (block.style === "info" || !["warning", "tip"].includes(block.style)) &&
              "border-sky-500 bg-sky-500/10",
          )}
        >
          <div className={richText} dangerouslySetInnerHTML={{ __html: block.content }} />
        </aside>
      );
